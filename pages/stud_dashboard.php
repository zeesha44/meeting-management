...
<?php
              ...
              //   // exit();
              // }
              if(strpos($fullUrl,"task=completed")==true){
                echo "<p style='color:green'>Task status updated successfully to in progress!<p>";
                // exit();
              }
              if(strpos($fullUrl,"task=failed")==true){
                echo "<p style='color:red'>Task status failed to update to in progress!<p>";
                // exit();
              }
                if(strpos($fullUrl,"taskc=completed")==true){
                echo "<p style='color:green'>Task status updated successfully to completed!<p>";
                // exit();
              }
              if(strpos($fullUrl,"taskc=failed")==true){
                echo "<p style='color:red'>Task status failed to update to completed!<p>";
                // exit();
              }
                ?>
<div class="page-body">
...
<div class="card-header-left ">
  ...
  $sql = "SELECT * FROM todo WHERE userid='$id' and status != 'completed'";
  ...
  while($row = $result->fetch_assoc()) {
    ...
    <tr>
      ...
      <td>
        <div class="dropdown">
          <a class="btn btn-outline-light dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <?php echo $row['status']; ?>
          </a>
