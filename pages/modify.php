...
<form method="post" action="modify.php">
  ...
  $sql = "SELECT * FROM user WHERE usertype = 'student' ORDER BY userid" ;
  ...
  while($row = $result->fetch_assoc()) {
    ...
    <tr>
      ...
      <td>
      <a href="modifyform.php?&id=<?php echo $row['userid'];?>"><button type="button" class="btn btn-light" style="background-color: #1e4da1; color: white;">Modify</button></a>
      </td>
    <tr>
      <?php
  }
...
<form method="post" action="modify.php">
  ...
  $sql = "SELECT * FROM user WHERE usertype = 'staff' ORDER BY userid";
  $result = $conn->query($sql);
  if (!$result) {
  trigger_error('Invalid query: ' . $conn->error);
  }
