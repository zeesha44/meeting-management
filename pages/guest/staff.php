...
$sql =  "INSERT INTO guest (staffemail, purpose, mdate, phone_no, email, fullname) VALUES ('$office','$purpose', '$timestamp', '$phone_no','$email', '$name')";
...
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Staff's Name</label>
  <input type="text" class="form-control" id="name" name="office" placeholder="staff name" required="">
</div>
<div class="mb-3">
